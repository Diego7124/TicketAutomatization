      ...
      <div className="app">
        ...
        <nav className="navbar">
          ...
          {firebaseUser ? (
            <div className="navbar-right">
              ...
              {isAdmin && (
                <button
                  className={`navbar-nav-btn ${view === 'analytics' ? 'active' : ''}`}
                  onClick={() => {
                    if (view === 'analytics') {
                      window.location.hash = 'ticket'
                      setView('ticket')
        ...
        <main className="main-content">
          ...
          {initializing ? (
            ...
            <ReportsDashboard apiBase={API_BASE} firebaseToken={firebaseToken} onBack={() => { window.location.hash = 'ticket'; setView('ticket') }} />
          ) : view === 'dashboard' ? (
            <Dashboard
              firebaseToken={firebaseToken}
              userRole={userRole}
